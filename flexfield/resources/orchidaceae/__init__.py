"""Flexfield resources for orchidaceae study."""
...
class OrchidResource(Resource):
    """Flask-Restful API endpoint to deal with orchid observations."""
    ...
    def post(self):
        ...
        insert_observation = getattr(anosql.load_queries(
            'postgres',
            os.path.join(os.path.dirname(flexfield.__file__), 'sql', 'insert_orchidaceae.sql')
